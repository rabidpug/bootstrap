# Generated by Powerlevel10k configuration wizard on 2019-12-08 at 12:15 AEDT.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 20339.
# Wizard options: powerline, rainbow, vertical separators, sharp heads, blurred tails,
# 2 lines, dotted, full frame, dark, compact, concise, transient_prompt,
